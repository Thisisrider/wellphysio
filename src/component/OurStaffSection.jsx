...
export default function OurStaffSection() {
    // Only show the first 4 members on the homepage
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                ...
                <div className="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <p className="text-lg text-gray-600 leading-relaxed">
                        Our team of highly skilled professionals is dedicated to providing you with the highest standard of care and expertise across a wide range of medical fields.
                    </p>
                </div>
                    ...
                    {displayMembers.map((member) => (
                        <div key={member.id} className="group relative bg-white rounded-3xl shadow-xl shadow-gray-200/50 overflow-hidden border border-gray-100 hover:-translate-y-2 transition-all duration-300">
                            ...
                            <div className="relative aspect-[4/5] overflow-hidden bg-gray-100">
                                ...
                                {/* Hover Social Links - positioned at bottom of image */}
                ...
                <div className="mt-16 text-center">
                    <Link href="/staff" className="group relative inline-flex items-center justify-center px-8 py-3.5 text-base font-bold text-violet-700 transition-all duration-300 bg-violet-100 rounded-full hover:bg-violet-200 hover:shadow-md hover:-translate-y-0.5 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-violet-600">
